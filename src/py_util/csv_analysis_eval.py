...
dataset = "ustancebr" # "ustancebr" or "semeval"
...
def get_pretrained_model_name(info):
    ...
    config_file_path = f"{config_base_path}/{dataset}/{data_folder_path}/{config_file_name}_v{int(version)}.txt"
...
best_valid = df.groupby(grp_cols_source) \
               [out_metrics+["version","valid_fmacro"]] \
