...
"""
        ...
        base_text = """
python train_model.py -m train -c ../../config/{data_folder}/{config_file_name}_v{k}.txt -t ../../data/ustancebr/v2/{data_folder}/final_bo_train.csv -v ../../data/ustancebr/v2/{data_folder}/final_bo_valid.csv -p ../../data/ustancebr/v2/{data_folder}/final_bo_test.csv -g ../../data/ustancebr/v2/simple_domain/final_lu_train.csv -n bo -e 5 -s 1 > ../../out/ustancebr/log/{data_folder}/bo_{config_file_name}_v{k}.txt
python train_model.py -m train -c ../../config/{data_folder}/{config_file_name}_v{k}.txt -t ../../data/ustancebr/v2/{data_folder}/final_lu_train.csv -v ../../data/ustancebr/v2/{data_folder}/final_lu_valid.csv -p ../../data/ustancebr/v2/{data_folder}/final_lu_test.csv -g ../../data/ustancebr/v2/simple_domain/final_bo_train.csv -n lu -e 5 -s 1 > ../../out/ustancebr/log/{data_folder}/lu_{config_file_name}_v{k}.txt
python train_model.py -m train -c ../../config/{data_folder}/{config_file_name}_v{k}.txt -t ../../data/ustancebr/v2/{data_folder}/final_co_train.csv -v ../../data/ustancebr/v2/{data_folder}/final_co_valid.csv -p ../../data/ustancebr/v2/{data_folder}/final_co_test.csv -g ../../data/ustancebr/v2/simple_domain/final_cl_train.csv -n co -e 5 -s 1 > ../../out/ustancebr/log/{data_folder}/co_{config_file_name}_v{k}.txt
python train_model.py -m train -c ../../config/{data_folder}/{config_file_name}_v{k}.txt -t ../../data/ustancebr/v2/{data_folder}/final_cl_train.csv -v ../../data/ustancebr/v2/{data_folder}/final_cl_valid.csv -p ../../data/ustancebr/v2/{data_folder}/final_cl_test.csv -g ../../data/ustancebr/v2/simple_domain/final_co_train.csv -n cl -e 5 -s 1 > ../../out/ustancebr/log/{data_folder}/cl_{config_file_name}_v{k}.txt
python train_model.py -m train -c ../../config/{data_folder}/{config_file_name}_v{k}.txt -t ../../data/ustancebr/v2/{data_folder}/final_gl_train.csv -v ../../data/ustancebr/v2/{data_folder}/final_gl_valid.csv -p ../../data/ustancebr/v2/{data_folder}/final_gl_test.csv -g ../../data/ustancebr/v2/simple_domain/final_ig_train.csv -n gl -e 5 -s 1 > ../../out/ustancebr/log/{data_folder}/gl_{config_file_name}_v{k}.txt
python train_model.py -m train -c ../../config/{data_folder}/{config_file_name}_v{k}.txt -t ../../data/ustancebr/v2/{data_folder}/final_ig_train.csv -v ../../data/ustancebr/v2/{data_folder}/final_ig_valid.csv -p ../../data/ustancebr/v2/{data_folder}/final_ig_test.csv -g ../../data/ustancebr/v2/simple_domain/final_gl_train.csv -n ig -e 5 -s 1 > ../../out/ustancebr/log/{data_folder}/ig_{config_file_name}_v{k}.txt
"""
